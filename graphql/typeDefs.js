...
module.exports = gql`
    ...
    type Mutation {
        ...
        createToDo(name: String!, time: String, date: String, body: String!, globality: Boolean!, canRemind: Boolean!, canComment: Boolean!, category: String, isPublic: Boolean!, viewList: ViewList!): ToDo!
